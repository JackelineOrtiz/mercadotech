...
> **Nota (Fase 7.5, 2026-09-01):** este archivo era el `README.md` de la raíz hasta el cierre de la
> Sesión 7. Es la planeación ORIGINAL del curso "Claude Code for Developers" — se conserva intacta
> acá por su valor propio (decisión 11 de `MercadoTech_sesion7.md`), pero **ya no describe el
> estado real del proyecto**. Para eso: [`README.md`](../README.md) (producto, puesta en marcha) y
> [`docs/ARQUITECTURA.md`](ARQUITECTURA.md) (arquitectura real, actualizada a la Sesión 7). Este
> documento queda como referencia histórica de qué pedía cada sesión — no se actualiza más.
