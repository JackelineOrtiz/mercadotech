...
-- Copia de REFERENCIA de las políticas RLS y de Storage. NO es la fuente de
-- verdad: la fuente de verdad son las migraciones individuales en
...
-- ============================================================
-- 20260819120000_create_storage_buckets.sql (Fase 2.4 — storage)
-- ============================================================
...
-- AMPLIADO en la Fase 4.7: getProductById (reutilizado por indexProduct)
