...
insert into public.products (id, seller_id, category_id, title, description, brand, condition, price, stock, is_active) values
  ('b0000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000001', 'Laptop Lenovo IdeaPad Slim 3 15.6" Ryzen 5 16GB 512GB SSD', 'Ideal para estudios y teletrabajo. Procesador AMD Ryzen 5, pantalla Full HD antirreflejo y batería de larga duración. Incluye Windows 11 preinstalado.', 'Lenovo', 'nuevo', 2850000.00, 8, true),
  ('b0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000001', 'Laptop HP Pavilion 14" Intel i5 8GB 512GB SSD', 'Diseño compacto y liviano, perfecta para uso diario y oficina. Procesador Intel Core i5 de última generación con gráficos integrados Iris Xe.', 'HP', 'nuevo', 3150000.00, 5, true),
  ('b0000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000002', 'Smartphone Samsung Galaxy A55 5G 128GB', 'Pantalla Super AMOLED de 6.6", cámara triple de 50MP y batería de 5000mAh. Compatible con redes 5G en Colombia.', 'Samsung', 'nuevo', 1750000.00, 12, true),
  ('b0000000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000002', 'Smartphone Xiaomi Redmi Note 13 Pro 256GB', 'Cámara principal de 108MP, carga rápida de 67W y pantalla AMOLED de 120Hz. Excelente relación precio-calidad.', 'Xiaomi', 'nuevo', 1150000.00, 15, true),
  ('b0000000-0000-0000-0000-000000000005', 'a0000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000003', 'Procesador AMD Ryzen 5 5600X', '6 núcleos y 12 hilos, ideal para armar una PC de rendimiento gama media-alta para trabajo y juegos.', 'AMD', 'nuevo', 780000.00, 10, true),
  ('b0000000-0000-0000-0000-000000000006', 'a0000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000003', 'Memoria RAM Kingston Fury 16GB DDR4 3200MHz', 'Kit de memoria de alto rendimiento, compatible con la mayoría de placas madre AMD e Intel modernas.', 'Kingston', 'nuevo', 320000.00, 20, true),
  ('b0000000-0000-0000-0000-000000000007', 'a0000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000006', 'Monitor LG 24" Full HD IPS', 'Panel IPS con colores precisos, ideal para diseño y oficina. Bordes delgados y soporte ajustable en altura.', 'LG', 'nuevo', 780000.00, 7, true),
  ('b0000000-0000-0000-0000-000000000008', 'a0000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000008', 'Router TP-Link Archer C6 AC1200', 'Router doble banda con 4 antenas externas, cobertura estable para hogares y oficinas pequeñas.', 'TP-Link', 'nuevo', 210000.00, 0, true),
  ...
  ('b0000000-0000-0000-0000-000000000010', 'a0000000-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000005', 'Teclado mecánico Logitech G413', 'Switches táctiles resistentes, estructura de aluminio y retroiluminación blanca. Pensado para gaming y productividad.', 'Logitech', 'nuevo', 320000.00, 14, true),
  ('b0000000-0000-0000-0000-000000000011', 'a0000000-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000005', 'Mouse gamer Razer DeathAdder V3', 'Sensor óptico de alta precisión, forma ergonómica y switches ópticos de larga duración.', 'Razer', 'nuevo', 280000.00, 18, true),
  ('b0000000-0000-0000-0000-000000000012', 'a0000000-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000004', 'Audífonos HyperX Cloud Stinger 2', 'Sonido envolvente 7.1, diadema ajustable y micrófono con cancelación de ruido. Compatible con PC, PS5 y Switch.', 'HyperX', 'nuevo', 250000.00, 25, true),
  ('b0000000-0000-0000-0000-000000000013', 'a0000000-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000004', 'Parlante JBL Flip 6', 'Sonido potente y resistente al agua (IP67), hasta 12 horas de batería. Ideal para exteriores.', 'JBL', 'nuevo', 480000.00, 9, true),
  ('b0000000-0000-0000-0000-000000000014', 'a0000000-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000005', 'Silla gamer Cougar Armor One', 'Reposabrazos 4D, reclinable hasta 180° y espuma de alta densidad. Soporta hasta 120kg.', 'Cougar', 'nuevo', 1050000.00, 6, true),
  ('b0000000-0000-0000-0000-000000000015', 'a0000000-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000007', 'Webcam Logitech C920 HD Pro', 'Video Full HD 1080p, enfoque automático y micrófono estéreo integrado. Ideal para streaming y videollamadas.', 'Logitech', 'nuevo', 350000.00, 11, true),
  ('b0000000-0000-0000-0000-000000000016', 'a0000000-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000005', 'Consola PlayStation 5 usada', 'Consola en buen estado, con un control original. Publicación pausada mientras el vendedor confirma disponibilidad.', 'Sony', 'usado', 2650000.00, 3, false);
